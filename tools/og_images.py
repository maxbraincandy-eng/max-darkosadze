...
def main():
    ...
    for lang in ("en", "ka"):
        ...
        for key in ("about", "articles", "films", "news", "foundation", "gallery", "legend", "guestbook", "contact", "press"):
            page = pages.get(key)
            if not page:
                continue
            photo = {"about": "portrait.jpg", "films": "film.jpg", "foundation": "foundation.jpg",
